      ...
      <script type="text/jsx">
        ...
        var Parent = React.createClass({
          ...
          render: function() {
            ...
            return <div>
              <p><input type="text" onChange={on_search} value={this.state.word} onKeyPress={handleKeyPress} /><div onMouseEnter={MouseOver} onMouseLeave={MouseOut} style={{display : 'inline-block'}}> {hst}</div></p>{videos}</div>;
          }
        });
